...
public class LoginAspect {
	...
	@Before("args(new_name)") 
	public void stringArgumentMethods(String new_name) // defined new_name as a String
	{
		System.out.println("A method that takes String arguments has been called " + new_name);
	}
